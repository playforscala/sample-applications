...
import com.ning.http.client.providers.grizzly.{ GrizzlyAsyncHttpProvider, FeedableBodyGenerator }
import com.ning.http.client.{ RequestBuilder, HttpResponseStatus, HttpResponseHeaders, HttpResponseBodyPart, AsyncHttpClient, AsyncHandler }
import javax.crypto.spec.SecretKeySpec
import javax.crypto.Mac
import play.api.http.HeaderNames
import play.api.libs.iteratee.Iteratee
import play.api.libs.ws.WS
import play.api.mvc.{ Results, Result, RequestHeader, BodyParser }
...
object AmazonBodyParsers extends Results {
  ...
  def S3Writer(objectId: String, request: Request, bodyGenerator: FeedableBodyGenerator): 
